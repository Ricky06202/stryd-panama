            ...
            <div className="space-y-8 animate-in fade-in duration-700">
              <Section title="Información del Atleta">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <FormField label="Provincia donde vive" id="provincia" name="province" />
                  <FormField
              ...
              <Section title="Salud">
                  <div className="space-y-6">
                    <FormField label="Tipo de Sangre" id="sangre" name="bloodType" />
                    <FormField
                    ...
                    <FormField
                      ...
                      name="pastInjuries"
                    />
                    <FormField label="¿Lesiones actuales?" id="lesiones_act" name="currentInjuries" />
                  </div>
                </Section>
                ...
                <Section title="Composición corporal">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <FormField
                      ...
                      type="number"
                    />
                    <FormField label="% Grasa" id="grasa" name="fatPercentage" type="number" />
                    <FormField label="Tipo de Pisada?" id="pisada" name="footwearType" />
                  </div>
                </Section>

                {/* Section 4: Records Personales (Solo para miembros actuales) */}
                {isAlreadyMember === true && (
                  <Section title="Records Personales">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <FormField label="5k (Tiempo)" id="record_5k" name="record5k" />
                      <FormField label="10k (Tiempo)" id="record_10k" name="record10k" />
                      <FormField label="21k (Tiempo)" id="record_21k" name="record21k" />
                      <FormField label="42k (Tiempo)" id="record_42k" name="record42k" />
                      <FormField label="W/kg (Vatios por kilo)" id="record_wkg" name="recordWkg" />
                      <FormField label="Nombre de usuario en Stryd" id="user_stryd" name="strydUser" />
                      <FormField label="Nombre de usuario en FinalSurge" id="user_finalsurge" name="finalSurgeUser" />
                      <FormField label="Fecha de inicio en el equipo" id="fecha_inicio" name="startDate" type="date" />
                    </div>
                  </Section>
                )}
                ...
                {isAlreadyMember === false && (
                  <Section title="Plan de Entreno">
                    <div className="space-y-4">
                      ...
                      <RadioGroup className="grid grid-cols-2 sm:grid-cols-4 gap-4" name="trainingDays">
                        {[
                          { v: '4', l: '4 días' },
                          { v: '5', l: '5 días' },
                          { v: '6', l: '6 días' },
